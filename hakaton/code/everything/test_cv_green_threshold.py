...
img = np.load("../image_with_green1.npy")
if img is None:
...
cv2.createTrackbar("H_low", "Settings", 35, 179, nothing)
cv2.createTrackbar("H_high", "Settings", 90, 179, nothing)
cv2.createTrackbar("S_low", "Settings", 50, 255, nothing)
cv2.createTrackbar("V_low", "Settings", 50, 255, nothing)
